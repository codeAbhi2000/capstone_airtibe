export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-6">
      ...
      >
        <div className="h-[420px] w-[420px] rounded-full bg-brand-500/10 blur-3xl" />
      </div>

      <div className="relative w-full max-w-md animate-slide-up">
        {/* Card */}
        <div className="rounded-2xl border border-border bg-card p-8 shadow-glow space-y-8 text-center">
          {/* Logo mark */}
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Connect your Gmail account to get AI-powered drafts that sound
              exactly like you.
            </p>
          </div>
